...
interface WindowProps {
  ...
  // FIX: Add props for voice control
  isListening: boolean;
...
export const Window: React.FC<WindowProps> = ({
  ...
  // FIX: Destructure voice control props
  isListening,
  ...
  return (
    <div
      className="w-[800px] h-[600px] bg-window border border-window-border rounded-xl shadow-2xl flex flex-col relative overflow-hidden font-sans"
      style={{backdropFilter: `blur(${glassEffectIntensity}px)`}}
    >
      {/* Title Bar */}
